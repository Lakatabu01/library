(function module() {
  ...
  sample.addEventListener("input", (event) => {
    if (sample.validity.tooShort) {
      sample.setCustomValidity("Length must be between 2 and 20 characters");
  ...
  sample1.addEventListener("input", (event) => {
    if (sample1.validity.tooShort) {
      sample1.setCustomValidity("Length must be between 2 and 20 characters");
  ...
  sample2.addEventListener("input", (event) => {
    if (sample2.validity.tooShort) {
      sample2.setCustomValidity("Must be more two or more pages");
      sample2.reportValidity();
    } else {
      sample2.setCustomValidity("");
    }
  });
  ...
  function addBookToLibrary() {
    if (
      sample.value.length > 20 ||
      sample.value.length < 2 ||
      sample1.value.length > 20 ||
      sample1.value.length < 2 ||
